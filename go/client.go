...
func (c *Client) Providers() ([]ProviderConfig, error) {
...
func (c *Client) GetFrom(provider ProviderConfig) (map[ID]ParkingLot, error) {
...
func (c *Client) GetFromMany(providers []ProviderConfig) (map[ID]ParkingLot, error) {
...
func (c *Client) GetFromManyGrouped(providers []ProviderConfig) (map[string]map[ID]ParkingLot, error) {
	var wg sync.WaitGroup
	var mu sync.Mutex
