	...
	ParkingLots: map[string]wheretopark.Metadata{
		"1": {
			...
			Comment: map[string]string{
				...
				`,
				"ru": `
					На двух верхних этажах здания торгового центра расположен двухуровневый паркинг на 1100 парковочных мест.
		...
		"2": {
			...
			Comment: map[string]string{
				"pl": `
					Dwupoziomowy parking rotacyjny
				`,
			},
			Rules: []wheretopark.Rule{
				{
		...
		"3": {
			...
			Comment: map[string]string{
				"pl": `
					Parking naziemny zlokalizowany przy stadionie Energa w Gdańsku.
				...
				`,
				"en": `
					Above-ground car park located by the Energa stadium in Gdańsk.
		...
		"5": {
			...
			Comment: map[string]string{
				"pl": `
					DODATKOWA GODZINA PARKOWANIA GRATIS - za zakupy na kwotę min. 50 zł (szczegóły w pkt. III ust. 4 [Regulaminu Parkingu](https://madison.gda.pl/pl/parking/regulamin-parkingu)).
		...
		"14": {
			...
			Comment: map[string]string{
				"pl": `
        			Zakup biletu wstępu na wystawę stałą: 4 godziny parkowania w cenie biletu / zabierz ze sobą bilet parkingowy, a kupując bilet na wystawę okaż bilet parkingowy w kasie (zrób to nim upłynie 30 minut od chwili zaparkowania)
				`,
				"en": `
        			ATTENTION! Ticket to the permanent exhibition | 4 hours parking included in ticket price. Take your parking ticket with you, and when buying your ticket for the permanent exhibition, present your parking ticket at the ticket office (do it before the 30 minutes have passed from the moment you parked)
				`,
			},
			Rules: []wheretopark.Rule{
				{
		...
		"15": {
			...
			Comment: map[string]string{
				"pl": `
					Klienci kina Helios - pierwsze 3h bezpłatnie (bilet parkingowy należy okazać w kasie kina)
		...
		"18": {
			...
			Comment: map[string]string{
				"pl": `
					Po wcześniejszym zgłoszeniu obsłudze przez kierującego takiej potrzeby pierwszy kwadrans będzie bezpłatny. 
