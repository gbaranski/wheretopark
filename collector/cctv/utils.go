...
func (spot *Spot) ImagePoints() []image.Point {
...
// PS: frame is image
func CropSpot(cvFrame gocv.Mat, spot *Spot) gocv.Mat {
...
func VisualizeSpotPrediction(img *gocv.Mat, spot Spot, prediction float32) {
...
func ExtractSpots(img gocv.Mat, spots []Spot) []gocv.Mat {
...
func generateVisualizationFor(model Model, camera *Camera) (gocv.Mat, error) {
